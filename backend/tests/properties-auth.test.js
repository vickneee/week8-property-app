...
describe('Property Controller', () => {
  ...
  it(
    'should return all properties as JSON when GET /api/properties is called',
    async () => {
  ...
  it(
    'should create a new property when POST /api/properties is called',
    async () => {
      const newProperty = {
      ...
      const propertyNames = propertiesAfterPost.map(
  ...
  it(
    'should return 404 for invalid property ID when PUT /api/properties/:id',
    async () => {
